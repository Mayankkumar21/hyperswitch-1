    ...
    for Forte
{
    ...
    fn get_url(
        ...
        Ok(format!("{}","https://sandbox.forte.net/api/v3/organizations/org_438436/locations/loc_316564/transactions/authorize" ))
    }
